...
public  class BoardRoomEntity extends Model{
    ...
    public List<ProjectorEntity> projectors() {
        return getMany(ProjectorEntity.class,"BoardRoomEntity");
    }

    public List<ModelEntity> models() {
        return getMany(ModelEntity.class,"BoardRoomEntity");
    }
    public List<AudioEntity> audios() {
        return getMany(AudioEntity.class,"BoardRoomEntity");
    }
    public List<TvEntity> tvs() {
        return getMany(TvEntity.class,"BoardRoomEntity");
    }
    public List<AirEntity> airs() {
        return getMany(AirEntity.class,"BoardRoomEntity");
    }
    public List<LightEntity> lights() {
        return getMany(LightEntity.class,"BoardRoomEntity");
    }
    public List<CurtainEntity> curtains() {
        return getMany(CurtainEntity.class,"BoardRoomEntity");
    }
    public List<SetAirEntity> setAirs() {
        return getMany(SetAirEntity.class,"BoardRoomEntity");
    }
