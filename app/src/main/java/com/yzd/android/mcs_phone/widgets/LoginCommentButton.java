...
/**
 */
public class LoginCommentButton extends ViewAnimator implements View.OnClickListener {
    ...
    public LoginCommentButton(Context context) {
        super(context);
        init();
    }

    public LoginCommentButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    private void init() {
        LayoutInflater.from(getContext()).inflate(R.layout.view_login_comment_button, this, true);
    }
