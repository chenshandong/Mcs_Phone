...
public class Constants {
    ...
    public static String SELECTORROOM = "SELECTORROOM";
    public static String SERVICES_DATA_VERSION = "SERVICES_DATA_VERSION";

    public static String LIGHT_PARCELABLE = "LIGHT_PARCELABLE";
