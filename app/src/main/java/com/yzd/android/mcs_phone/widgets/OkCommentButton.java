...
/**
 */
public class OkCommentButton extends ViewAnimator implements View.OnClickListener {
    ...
    public OkCommentButton(Context context) {
        super(context);
        init();
    }

    public OkCommentButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    private void init() {
        LayoutInflater.from(getContext()).inflate(R.layout.view_ok_comment_button, this, true);
    }
